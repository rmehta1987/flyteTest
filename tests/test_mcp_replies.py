...
class McpRepliesTests(TestCase):
    ...
    def test_run_reply_round_trips_through_asdict(self) -> None:
        ...
        reply = RunReply(
            ...
            artifact_path=".runtime/runs/20260420T101112.123Z-exonerate_align_chunk/spec.json",
    ...
    def test_run_reply_contract_uses_exactly_one_target_name(self) -> None:
        ...
        task_reply = RunReply(
            ...
            artifact_path=".runtime/runs/20260420T101112.123Z-fastqc/spec.json",
            execution_profile="local",
            execution_status="success",
            exit_status=0,
        ...
        workflow_reply = RunReply(
            ...
            artifact_path=".runtime/runs/20260420T101112.123Z-protein_evidence_alignment/spec.json",
    ...
    def test_plan_success_round_trips_through_asdict(self) -> None:
        ...
        reply = PlanSuccess(
            ...
            artifact_path=".runtime/runs/20260420T101112.123Z-composed/spec.json",
    ...
    def test_dry_run_reply_round_trips_through_asdict(self) -> None:
        ...
        reply = DryRunReply(
            supported=True,
            recipe_id="20260420T101112.123Z-busco_annotation_qc_workflow",
            artifact_path=".runtime/runs/20260420T101112.123Z-busco_annotation_qc_workflow/spec.json",
            execution_profile="slurm",
            resolved_bindings={
