...
PYTHON_SCRIPT="$SCRIPT_DIR/run_m19_approval_gate_smoke.py"

# RCC-first defaults for the Milestone 19 approval-gate smoke. Override any
# of these before running when the allocation or saved-path assumptions differ.
...
export FLYTETEST_SLURM_WALLTIME="${FLYTETEST_SLURM_WALLTIME:-00:15:00}"
...
export FLYTETEST_SLURM_JOB_PREFIX="${FLYTETEST_SLURM_JOB_PREFIX:-m19-approval}"
