...
VARIANT_CALLING_ENTRIES: tuple[RegistryEntry, ...] = (
    ...
    RegistryEntry(
        ...
        outputs=(
            InterfaceField("preprocessed_bam_from_ubam", "str", "Path to BQSR-recalibrated BAM produced via the uBAM path."),
        ),
    ...
    RegistryEntry(
        ...
        category="workflow",
        description="Call per-sample GVCFs scattered across genomic intervals, then gather into a single GVCF.",
        inputs=(
            InterfaceField("ref_path", "str", "Absolute path to reference FASTA."),
            InterfaceField("bam_path", "str", "Absolute path to BQSR-recalibrated BAM."),
            InterfaceField("sample_id", "str", "Sample identifier."),
            InterfaceField("intervals", "list[str]", "Non-empty list of genomic intervals in genomic order."),
            InterfaceField("results_dir", "str", "Output directory for the gathered GVCF."),
            InterfaceField("sif_path", "str", "Optional Apptainer/Singularity image path."),
        ),
        outputs=(
            InterfaceField("scattered_gvcf", "str", "Path to the gathered per-sample GVCF."),
        ),
        tags=("variant_calling", "gatk4", "gvcf", "scatter-gather", "workflow"),
        compatibility=RegistryCompatibilityMetadata(
            biological_stage="GATK4 interval-scattered HaplotypeCaller with gather",
            accepted_planner_types=("ReferenceGenome", "AlignmentSet"),
            produced_planner_types=("VariantCallSet",),
            reusable_as_reference=True,
            execution_defaults={
    ...
    RegistryEntry(
        ...
        inputs=(
            ...
            InterfaceField("cohort_id", "str", "Cohort identifier used to name the output VCF."),
            InterfaceField("results_dir", "str", "Output directory."),
            InterfaceField("supporting_callsets", "list[str]", "Optional list of population VCF paths for prior refinement."),
            InterfaceField("sif_path", "str", "Optional Apptainer/Singularity image path."),
        ),
        outputs=(
            InterfaceField("refined_vcf_cgp", "str", "Path to the CGP-refined cohort VCF (.vcf.gz)."),
        ),
    ...
    RegistryEntry(
        ...
        inputs=(
            InterfaceField("gvcf_paths", "list[str]", "Ordered list of per-interval GVCF paths (genomic order, non-overlapping)."),
            InterfaceField("sample_id", "str", "Sample identifier used to name the output GVCF."),
            InterfaceField("results_dir", "str", "Output directory."),
            InterfaceField("sif_path", "str", "Optional Apptainer/Singularity image path."),
        ),
        outputs=(
            InterfaceField("gathered_gvcf", "str", "Path to the merged GVCF (.g.vcf.gz)."),
        ),
    ...
    RegistryEntry(
        ...
        inputs=(
            InterfaceField("ref_path", "str", "Reference FASTA path (unused by CGP; kept for interface consistency)."),
            InterfaceField("vcf_path", "str", "Absolute path to input VCF (joint-called or VQSR-filtered)."),
            InterfaceField("cohort_id", "str", "Cohort identifier used to name the output VCF."),
            InterfaceField("results_dir", "str", "Output directory."),
            InterfaceField("supporting_callsets", "list[str]", "Optional list of population VCF paths for prior refinement."),
        ...
        outputs=(
            InterfaceField("cgp_vcf", "str", "Path to the CGP-refined VCF (.vcf.gz)."),
        ),
