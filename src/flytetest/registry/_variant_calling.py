...
VARIANT_CALLING_ENTRIES: tuple[RegistryEntry, ...] = (
    ...
    RegistryEntry(
        ...
        inputs=(
            InterfaceField("reference_fasta", "File", "Reference genome FASTA."),
            InterfaceField("bwa_sif", "str", "Apptainer SIF for bwa-mem2+samtools. Build: bash scripts/rcc/build_bwa_mem2_sif.sh"),
        ),
        outputs=(
            InterfaceField("bwa_index_prefix", "Dir", "Directory containing BWA-MEM2 index files."),
        ),
        tags=("variant_calling", "bwa-mem2", "alignment", "reference_prep"),
        compatibility=RegistryCompatibilityMetadata(
            ...
            execution_defaults={
                ...
                "runtime_images": {"bwa_sif": "data/images/bwa_mem2.sif"},
    ...
    RegistryEntry(
        ...
        tags=("variant_calling", "bwa-mem2", "alignment"),
        compatibility=RegistryCompatibilityMetadata(
    ...
    RegistryEntry(
        ...
        inputs=(
            ...
            InterfaceField("bcftools_sif", "str", "SIF fallback for bcftools. Prefer HPC module: add 'bcftools/<version>' to module_loads in your resource_request instead."),
        ),
        outputs=(
        ...
        compatibility=RegistryCompatibilityMetadata(
            ...
            execution_defaults={
                ...
                "module_loads": ("python/3.11.9", "apptainer/1.4.1", "bcftools"),
            },
            supported_execution_profiles=("local", "slurm"),
            synthesis_eligible=True,
            composition_constraints=(
    ...
    RegistryEntry(
        ...
        inputs=(
            ...
            InterfaceField("multiqc_sif", "str", "SIF fallback for MultiQC. Prefer HPC module: add 'multiqc/<version>' to module_loads in your resource_request instead."),
        ),
        outputs=(
        ...
        compatibility=RegistryCompatibilityMetadata(
            ...
            execution_defaults={
                ...
                "module_loads": ("python/3.11.9", "apptainer/1.4.1", "multiqc"),
            },
            supported_execution_profiles=("local", "slurm"),
            synthesis_eligible=True,
            composition_constraints=(
