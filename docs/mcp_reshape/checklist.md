...
| 15 | `list_available_bindings` additive `typed_bindings` field | §3f | `prompts/step_15_list_available_bindings_typed.md` | Complete |
...
| 25 | Register `list_bundles` / `load_bundle` on the server | §4 (server) | `prompts/step_25_bundle_tools_server.md` | Complete |

### Sweep + docs

| # | Step | Plan section | Prompt | Status |
|---|------|--------------|--------|--------|
| 26 | Call-site sweep for the BC migration | §12 | `prompts/step_26_call_site_sweep.md` | Complete |
